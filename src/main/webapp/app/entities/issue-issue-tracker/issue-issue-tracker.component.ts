...
@Component({
    selector: 'jhi-issue-issue-tracker',
    templateUrl: './issue-issue-tracker.component.html'
})
export class IssueIssueTrackerComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.issueService
            ...
            .subscribe(
                (res: HttpResponse<IIssueIssueTracker[]>) => this.paginateIssues(res.body, res.headers),
    ...
    trackId(index: number, item: IIssueIssueTracker) {
        return item.id;
    }
    ...
    private paginateIssues(data: IIssueIssueTracker[], headers: HttpHeaders) {
